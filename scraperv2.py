...
if __name__ == "__main__":
    ...
    """
    settings for thoroughness
    headless first run, normal second, slow third
    
python pdf_scraper_threaded.py --email ianmoog@buffalo.edu --max 61000  --threads 24 --selenium-threads 12 --jobs-file jobs.jsonl --verbose --headless
python pdf_scraper_threaded.py --email ianmoog@buffalo.edu --max 61000  --threads 12 --selenium-threads 10 --jobs-file jobs.jsonl --verbose
